# This graph gives the density of American Tropical Interpretive Center with respect to Firehouse Museum
...
museum_data['America Tropical Interpretive Center'].plot.kde(ind = np.arange(0, museum_data['Firehouse Museum'].max()));